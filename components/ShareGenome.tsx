...
export function ShareGenome({
  ...
  return (
    <form onSubmit={share} className="rounded-2xl border border-stone-200 bg-white p-5 sm:p-6">
      <h3 className="text-lg font-semibold text-stone-900">Share the Broker-Safe Handover</h3>
      ...
      <p className="mt-1 max-w-prose text-base leading-relaxed text-stone-600">
        Sends the broker-safe version of your Operating Manual — the same document you can read below. Anything
