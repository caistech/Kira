...
export const metadata: Metadata = {
  title: 'What your business is worth · Kira',
  description:
    'The three-minute indicative valuation: what the business would fetch today, and what it is worth once the operating knowledge in your head is captured.',
};
