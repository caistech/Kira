    ...
    parameters: {
      ...
      properties: {
        ...
        intent_id: {
          type: 'string',
          description:
            'Only set when answering a clarifying response: pass the intent_id returned by that call back unchanged, so the answers close the SAME task instead of starting a new one.',
        },
        clarification: {
          type: 'object',
          description:
            'Only set when answering a clarifying response: `answers` maps the question fields (successCriteria, dueAt, objective, responsibleTier) to what the owner said, verbatim.',
          properties: {
            answers: {
              type: 'object',
              description: 'The owner\'s answers, keyed by the field names asked in the clarifying response.',
            },
          },
        },
      },
