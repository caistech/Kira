...
| **B7** | The export has no sensitivity filter at all | **BUG** | **1** | — | The QA export's entire content is *"the owner is considering selling after 35 years and has not told anyone."* Anything classified into a section goes verbatim into the document described as being for a buyer's accountant. That is the single worst negotiating disclosure a seller can make, and nothing gates it. |
