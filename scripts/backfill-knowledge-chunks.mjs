...
const { NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SECRET_KEY, ELEVENLABS_API_KEY, OPENAI_API_KEY } = process.env;
const FORCE = process.argv.includes('--force');
const CHUNK_SIZE = 1500, CHUNK_OVERLAP = 200, DIMS = 1536;

if (!SUPABASE_SECRET_KEY || !ELEVENLABS_API_KEY || !OPENAI_API_KEY) {
  throw new Error('Need NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SECRET_KEY, ELEVENLABS_API_KEY, OPENAI_API_KEY');
}
