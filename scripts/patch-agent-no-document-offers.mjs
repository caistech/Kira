// Patch the live fleet with the exhaustive-capability rule added 2026-08-17.
//
...
//
//   node scripts/patch-agent-no-document-offers.mjs            # dry run (default)
//   node scripts/patch-agent-no-document-offers.mjs --apply
...
const ANCHOR = '- **set a reminder** for the owner themselves';
const NEXT_BULLET = '## WHAT YOU CANNOT REACH YET';
const MARKER = 'THAT LIST IS EXHAUSTIVE';
